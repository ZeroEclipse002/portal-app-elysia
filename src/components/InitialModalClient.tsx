...
const InitialModalClient = ({ path }: { path: string }) => {
  ...
  const updateFamilyMember = useCallback(
    (index: number, field: keyof FamilyData, value: string) => {
      setFamilyMembers((prev) => {
  ...
  const inputStyles =
    "w-full p-2.5 rounded-lg border-slate-200 bg-slate-50 text-slate-700 border focus:ring-2 focus:ring-slate-400 focus:border-slate-400 outline-none placeholder:text-slate-400";
  ...
  const FamilyMemberForm = useMemo(() => {
    return familyMembers.map((member, index) => (
      <div
        key={index}
        className="flex flex-col gap-5 bg-slate-50 p-4 md:p-7 rounded-xl border border-slate-100 relative"
      >
        ...
        <div className="flex flex-col md:flex-row justify-between gap-4">
          ...
          <div className="flex-1">
            ...
            <input
              ...
              onChange={(e) =>
                updateFamilyMember(index, "birthDate", e.target.value)
              }
              className={inputStyles}
            />
          </div>
  ...
  const MainModalContent = useMemo(
    () => (
      <div className="flex flex-col gap-5 bg-white p-4 md:p-7 rounded-xl shadow-sm">
        ...
        {error.length > 0 && (
          <div className="flex flex-col gap-2 border border-red-500 p-2 rounded-lg">
            {error.map((e, index) => (
        ...
        <div className="flex flex-col md:flex-row justify-between gap-4">
          ...
          <div className="flex-1">
            ...
            <input
              ...
              onChange={(e) =>
                handlePersonalDetailsChange("birthDate", e.target.value)
              }
              className={inputStyles}
            />
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between gap-4">
          <div className="flex-1">
            ...
            <select
              ...
              onChange={(e) =>
                handlePersonalDetailsChange("gender", e.target.value)
              }
              className={inputStyles}
            >
              <option value="">Select gender</option>
        ...
        <p className="text-slate-600 text-sm">
          You have added {familyMembers.length} family members
        </p>
        <button
            ...
            <div className="flex-shrink-0 flex flex-col md:flex-row items-start md:items-center justify-between p-4 md:p-7 border-b border-slate-100">
              ...
              <div className="flex flex-col md:flex-row items-start md:items-center gap-4">
                ...
                <span className="text-sm text-slate-600 bg-slate-100 p-2 rounded-lg">
                  ...
                  {familyMembers.length === 1 ? "member" : "members"} added
                </span>
                <button
